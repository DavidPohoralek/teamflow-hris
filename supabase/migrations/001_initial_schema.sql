...
-- ─── Work Plans (individual scheduled shifts) ─────────────────────────────────
...
-- ─── Requests (vacation, sick, correction) ────────────────────────────────────
...
create policy "org_isolation" on profiles for all using (
